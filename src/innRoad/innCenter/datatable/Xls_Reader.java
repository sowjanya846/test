package innRoad.innCenter.datatable;
	...
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
			...
			if (cell.getCellType() == Cell.CELL_TYPE_STRING) {
				System.out.println("satish 111111111111111"
						+ cell.getCellType());
				...
				System.out.println("janpasha   " + cellText);
				// String s1 = s.getCell(2,i).getContents();
	...
	public String getCellData(String sheetName, int colNum, int rowNum) {
		try {
			...
			if (cell.getCellType() == Cell.CELL_TYPE_STRING) {
				...
				String cellText = String.valueOf(cell.getNumericCellValue());
				double f = Double.parseDouble(cellText);
				cellText = String.format("%.2f", new BigDecimal(f));
				// System.out.println("this is formula "+cellText);
